...
LOCAL _DEFAULT_AIRCRAFT IS LEXICON(
  ...
  "amo_engine_side_eps_m",0.25,
  "amo_engine_left_tag", "",
  "amo_engine_right_tag","",
  "amo_engine_module_name","",
  "amo_engine_field_name","",
  "amo_engine_field_base",-1,
...
FUNCTION _RUN_FLIGHT_PLAN {
  ...
  AS_DISCOVER_PARTS().
  LOGGER_INIT().
  IF CONFIG:IPU < IFC_MIN_IPU {
    SET CONFIG:IPU TO IFC_MIN_IPU.
  }
