...
FUNCTION BUILD_AIRCRAFT_CONFIG {
  RETURN LEXICON(
    ...
    "gear_down_agl", 300,
    "gear_max_extend_ias", 120, // m/s max IAS to auto-extend gear (<= 0 disables speed gate)
    ...
    "flare_authority_pitch_err_trigger",-1, // deg pitch tracking trigger for authority-limited detector (-1 = global)
