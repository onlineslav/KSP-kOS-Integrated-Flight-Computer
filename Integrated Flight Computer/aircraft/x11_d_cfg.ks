...
FUNCTION BUILD_AIRCRAFT_CONFIG {
  RETURN LEXICON(
    ...
    "v_app",        150.0,  // prev: 140,175,200  // we want ~10-15deg aoa (150 gives 10deg aoa) (140 gives 13.8deg aoa)
    "v_ref",        130.0,  // prev: 130,130,150,170
    ...
    "v_r",                120.0,  // m/s  rotate speed
    "v2",                150.0,  // m/s  V2 climb speed
    "takeoff_pitch_tgt",  10,  // deg  pitch target at rotation
