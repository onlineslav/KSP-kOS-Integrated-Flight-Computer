...
FUNCTION BUILD_AIRCRAFT_CONFIG {
  RETURN LEXICON(
    ...
    // ========================================================
    "name", "C-1000H SkyDiva",                   // [string]          Aircraft display name shown in IFC status and logs.                              
...
//  "vs0", 92.0,                              // [m/s]             Landing-configuration stall speed estimate used for protection/scheduling logic. UNUSED
    ...
    "amo_engine_side_eps_m", 0.05,             // [m]               Engine lateral split epsilon for automatic AMO left/right bank detection.
    "amo_engine_left_tag", "",                 // [string]          Optional part tag to force left-side engine bank.
    "amo_engine_right_tag", "",                // [string]          Optional part tag to force right-side engine bank.
...
//  "takeoff_dir_max_corr", 6.0,              // [deg]             Max heading correction passed to director channel.                               (6.0) UNUSED
    ...
    "vfe_landing", 120,                       // [m/s]             Max IAS permitted in landing flap detent.                                        
    ...
    "flaps_landing_km", 10,                   // [km]              Distance cue for landing-detent selection.                                       
