...
FUNCTION BUILD_AIRCRAFT_CONFIG {
  RETURN LEXICON(
    ...
    // -- Takeoff --------------------------------------------
    "has_nws",            FALSE, // X10-G has no nose wheel steering
    ...
    "takeoff_yaw_kp",          0.12,  // was 0.038 — rudder-only (no NWS), needs ~3x NWS-assist level
    "takeoff_yaw_kd",          0.040, // was 0.018 — more damping to prevent overshoot at higher gain
    "takeoff_yaw_boost_err_deg", 0.40, // unchanged — boost kicks in below 1 deg error
    "takeoff_yaw_boost_max",   0.50,  // was 0.25 — more headroom for large initial heading bias
