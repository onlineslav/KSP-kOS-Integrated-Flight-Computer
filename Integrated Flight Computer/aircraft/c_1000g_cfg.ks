...
FUNCTION BUILD_AIRCRAFT_CONFIG {
  RETURN LEXICON(
    ...
    // ========================================================
    "name", "C-1000G SkyDiva",                   // [string]          Aircraft display name shown in IFC status and logs.                              
...
//  "vs0", 92.0,                              // [m/s]             Landing-configuration stall speed estimate used for protection/scheduling logic. UNUSED
    ...
    "abrk_field_base", 70,                    // [number]          Optional full-scale value for abrk_field_name (-1 = auto).
